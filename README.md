...
![Delivery project](https://github.com/NiMeItachi/delivery_project/blob/master/delivery_app_git/Delivery.png)
...
1. Clone the repository: git clone https://github.com/NiMeItachi/delivery_app.git
